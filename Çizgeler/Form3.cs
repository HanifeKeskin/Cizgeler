...
namespace Çizgeler
{
    public partial class frmMinKapsayanAgac : Form
    {
        Graph birGraph;
        public frmMinKapsayanAgac(Graph birGraph)
        {
            this.birGraph = birGraph;
            InitializeComponent();
        }

        private void frmMinKapsayanAgac_Load(object sender, EventArgs e)
        {
            float a = 0, b = 0, a2, b2;
